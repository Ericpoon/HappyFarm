...
function RadarChart(id, data, options, showDetailedChart) {
    var cfg = {
        ...
        opacityArea: 0.15, 	//The opacity of the area of the blob // 0.35
